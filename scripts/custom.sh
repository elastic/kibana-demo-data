...
process_remote "https://elastic.github.io/kibana-demo-data/data/logs-apache.error.ndjson"
process_remote "https://elastic.github.io/kibana-demo-data/data/logs-aws.s3.ndjson"
process_remote "https://elastic.github.io/kibana-demo-data/data/logs-custom.multiplex.ndjson"
process_remote "https://elastic.github.io/kibana-demo-data/data/logs-k8s.container.ndjson"
process_remote "https://elastic.github.io/kibana-demo-data/data/logs-nginx.error.ndjson"
process_remote "https://elastic.github.io/kibana-demo-data/data/logs-nqinx.ndjson"
process_remote "https://elastic.github.io/kibana-demo-data/data/logs-system.error.ndjson"
...
process_remote_kibana "https://elastic.github.io/kibana-demo-data/data/logs-k8s.container.ndjson"
