...
curl -u ${username}:${password} -X POST "${kibana_url}${dev_prefix}/api/sample_data/logstsdb" -s -o /dev/null -H 'kbn-xsrf: true' -H 'elastic-api-version: internal' -H 'Content-Type: application/json' 2>&1
