...
show_help() {
  ...
  echo "  edgecase  Install edge case data with 50,000 unique fields across 10 indices and 20 test documents"
  echo
...
# available scripts
scripts="custom o11y sample searchkit security makelogs edgecase"
