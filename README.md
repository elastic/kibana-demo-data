...
- **Edge Case Data** with 50,000 dynamically generated unique fields across 10 indices (5,000 unique fields each) and 20 test documents for testing massive field scenarios (`edgecase`)
...
To install **Edge Case Data** with 50,000 dynamically generated unique fields across 10 indices and 20 test documents:
