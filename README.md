...
- **Edge Case Data** with 50,000 dynamically generated unique fields across 5 indices (10,000 unique fields each) and 50 test documents for testing massive field scenarios (`edgecase`)
...
To install **Edge Case Data** with 50,000 dynamically generated unique fields across 5 indices and 50 test documents:
